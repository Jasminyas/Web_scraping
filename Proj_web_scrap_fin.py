...
######################################################
#     PYTHON PROJECT - Master 2 IMSD - ENSIIE        #
#     WEB SCRAPING - user comments word clouds       #
...
for i in range(30,200,30):
    url_etabs.append(url_etab+"/Restaurants-g187147-oa"+str(i)+"-Paris_Ile_de_France.html")#7 premieres pages
...
for u in url_etabs:
    ...
    for l in listingIndex:
        try:
            ...
            print("Une petite erreur car certaines valeurs ne sont pas bien formatées c'est pas grave! on va les remplacer par --")
...
### TEST SELENIUM IDEA : because full comments are only displayed when clicking on a button - doesn't work #####
#==============================================================================
...
####################### Yasmine MARICAR : Récupération des commentaires et nuage de mots ################################################
